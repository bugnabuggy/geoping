...
namespace GeoPing.Infrastructure.Data.Migrations
{
    ...
    [Migration("20181228112513_AddedPaymentOperatorFieldToOrderEntity")]
    partial class AddedPaymentOperatorFieldToOrderEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GeoPing.Core.Models.Entities.CheckIn", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GeoPing.Core.Models.Entities.GeoPingToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GeoPing.Core.Models.Entities.GeoPingUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GeoPing.Core.Models.Entities.GeoPoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GeoPing.Core.Models.Entities.ListReview", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("GeoPing.Core.Models.Entities.ListSharing", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("GeoPing.Core.Models.Entities.Order", b =>
                {
                    ...
                    b.Property<int>("PaymentOperator");
            ...
            modelBuilder.Entity("GeoPing.Core.Models.Entities.SupportMessage", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("GeoPing.Core.Models.Entities.CheckIn", b =>
                {
                    b.HasOne("GeoPing.Core.Models.Entities.GeoPoint", "Geopoint")
                        .WithMany()
            ...
            modelBuilder.Entity("GeoPing.Core.Models.Entities.GeoPoint", b =>
                {
                    b.HasOne("GeoPing.Core.Models.Entities.GeoList", "Geolist")
                        .WithMany()
            ...
            modelBuilder.Entity("GeoPing.Core.Models.Entities.ListSharing", b =>
                {
                    b.HasOne("GeoPing.Core.Models.Entities.GeoList", "List")
                        .WithMany()
                        .HasForeignKey("ListId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("GeoPing.Core.Models.Entities.PublicList", b =>
                {
                    b.HasOne("GeoPing.Core.Models.Entities.GeoList", "Geolist")
                        .WithOne()
                        .HasForeignKey("GeoPing.Core.Models.Entities.PublicList", "ListId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
